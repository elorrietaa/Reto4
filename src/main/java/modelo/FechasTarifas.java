...
/**
 * Clase FechasTarifas = contiene VARIABLES Y ARRAYS que contienen DATOS
...
public class FechasTarifas {
    ...
    // Declaración e inicialización de los meses de los días festivos. NOTA: los
    // meses se guardan de O a 11 siendo 0 enero y 11 diciembre.
    ...
    public final static int[] diasFestivos = { diaAnoNuevo, diaReyes, diaFiestaTrabajo, diaVigenMaria, diaHispanidad,
	    diaTodosSantos, diaConstitucion, diaConcepcion, diaNatividad };

    // Este array contiene los meses de los festivos
    public final static int[] mesesFestivos = { mesAnoNuevo, mesReyes, mesFiestaTrabajo, mesVigenMaria, mesHispanidad,
	    mesTodosSantos, mesConstitucion, mesConcepcion, mesNatividad };

    // Este array contiene los nombres de los festivos
    public final static String[] nombreFestivos = { nombreFestivoAnoNuevo, nombreFestivoReyes, nombreFestivoTrabajo,
	    nombreFestivoVigenMaria, nombreFestivoHispanidad, nombreFestivoTodosSantos, nombreFestivoConstitucion,
	    nombreFestivoConcepcion, nombreFestivoNatividad };
