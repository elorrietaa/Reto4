...
/**
 * Clase PanBuscarHotel: contiene los elementos necesarios para formar el Panel
 * en el que se realiza la búsqueda del alojamiento
 * 
 * @author alba
 *
 */
public class PanBuscarAlojamiento extends JPanel {
    ...
    public JButton buttonContinuar, btnAplicarFiltros, btnRegistro, btnInicioSesion, btnCancelar, btnCerrarSesion,
	    btnServicios, btnContratar, btnCancelarSer, btnActualizar;
    ...
    public JLabel labelHotel, labelCiudad, lblTipoAloj, labelServicios, lblMensajeContratar, lblMensajeActualizar,
	    lblLoSentimosNo, lblNewLabel, lblFechaDeSalida;
    public JCalendar fechaIda, fechaVuelta;
    public JCheckBox chckbxWifiSel, chckbxAireSel, chckbxPiscinaSel, chckbxSpaSel, chckbxGimSel, chckbxParkingsel,
	    chckbxRestSel, chckbxBarSel;
	...
	lblMensajeContratar = new JLabel(
		"No olvide pulsar \"Contratar\" o los servicios adicionales no se a\u00F1adir\u00E1n a su compra.");
	...
	lblMensajeActualizar = new JLabel(
		"Por favor, pulse \"Actualizar servicios\" para ver los servicios del alojamiento seleccionado.");
	...
	lblLoSentimosNo = new JLabel(
		"Lo sentimos, no hay alojamientos que cumplan con sus criterios de b\u00FAsqueda.");
