...
public class ControladorLogin implements ActionListener {
	...
	case "Iniciar Sesión":
	    ...
	    char[] cont = vista.login.password.getPassword(); // Recoge la contraseña que ha sido introducida desde la
							      // interfaz.
	    String contString = new String(cont); // Transforma la contraseña que esta en un array de caracteres a
						  // String.

	    // comprobamos si el usuario esta registrado
	    modelo.cliente = controlador.funcionesRegistro.comprobarInicio(dni, contString); // Llamada a la funcion
											     // comprobarInicio.
		...
		JOptionPane.showMessageDialog(vista, "Datos erróneos. Inténtelo de nuevo", "Aviso",
