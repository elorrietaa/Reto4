...
public class ControladorPanVueltas implements ActionListener {
    ...
    public ControladorPanVueltas(JframePrincipal vista, PrincipalModelo modelo, PrincipalControlador controlador,
	    ControladorPanPago pago) {
	this.vista = vista;
	this.modelo = modelo;
	...
	case "Finalizar":
	    JOptionPane.showMessageDialog(vista, "Reserva realizada con exito, muchas gracias.", "Informacion",
