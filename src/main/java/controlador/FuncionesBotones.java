...
public class FuncionesBotones {
     ...
     * 
     * @param pago Instancia del controlador de pago para poder acceder a sus
     *             elementos
     */
    ...
    /**
     * Método resetAtrasPago = se utiliza este método para resetear los valores de
     * pago cuando el usuario pulse el boton atrás en el panel de pago.
     * 
     * @param pago Instancia del controaldor del panel de pago para poder acceder a
     *             sus elementos
     */
    ...
    /**
     * Método cerrarSesion = se resetean los valores necesarios para cuando el
    ...
    /**
     * Método resetServicios = se resetean los servicios en el panel d ebuscar
     * alojamiento.
     */
