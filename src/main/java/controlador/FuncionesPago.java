...
public class FuncionesPago {
    ...
    /**
     * Metodo que se encarga de redimensionar un array que se le pasa por parametro
     * a uno una posicion mayor
     * 
     * @param arrayRedimensionar Es el array que se desea redimensionar, se le para
     *                           como parametro a la funcion
     * 
     * @return arrayRedimensionado. Devuelve el array una vez ha sido redimensionado
     *         y se ha copiado el contenido del array que se queria redimensionar
     */
	...
	System.arraycopy(arrayRedimensionar, 0, arrayRedimensionado, 0, arrayRedimensionar.length); // Copia
												    // arrayRedimensionar
												    // en
												    // arrayRedimensionado,
												    // el cuel es una
	...
	System.arraycopy(arrayRedimensionar, 0, arrayRedimensionado, 0, arrayRedimensionar.length - 1); // Copia
													// arrayRedimensionar
													// en
													// arrayRedimensionado,
													// el cuel es
    ...
    /**
     * Metodo que se encarga de calcular el menor numero de monedas que se tienen
     * que dar de devolucion
     * 
     * @param total  Dinero total que se debe introducir
	...
	{
	    sobra = dinero - total;
	    if (sobra >= 200) // si la cantidad es mayor que este num, se divide entre el para saber la
			      // cantidad de billetes de este tipo,y calcula el resto para saber el dinero que
			      // le queda por analizar.
	    {
		cont = (int) sobra / 200;
		sobra = sobra % 200;
