...
public class ContrPanDetReservaAloj implements ActionListener {
	...
	if (sourceObject instanceof JButton) {
		...
		if (modelo.tiposAloj.getCodTipoAlojamiento() == 10) {
			...
			|| modelo.tiposAloj.getCodTipoAlojamiento() == 30) {
	...
	if (modelo.cliente == null) {
	    ...
	    // muestra el número de personas que pueden alojarse en el alojamiento teniendo
	    // en cuenta el número y el tipo de camas que tienen las habitaciones del
	    // alojamiento
