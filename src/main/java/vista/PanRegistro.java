...
public class PanRegistro extends JPanel {
    ...
    public JLabel lblNombre, lblApellidos, lblDni, lblSexo, lblPassword, lblPassword2, lblfechaNac, lblErrorDNI,
	    lblErrorContrasenas, lblErrorSexo, lblErrorDNINoIntroducido;
