...
/**
 * Esta clase se utiliza para validar el DNI del usuario y encriptar su
 * contraseña
 * 
 */
public class FuncionesRegistro {
     ...
     * 
     * @return Retorna true o false si el DNI ha sido validad satisfactoriamente o
     *         no respectivamente
     */
     ...
     * 
     * @return Retorna true o false si la comprobacion ha dado un resultado
     *         satisfactoriamente o no respectivamente
     */
	...
	try {
	    ...
	    // Coge los bytes separados de la contraseña en hexadecimal y los junta en un
	    // string
