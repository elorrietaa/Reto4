...
public class FormatoDiseno {
    ...
    public static void tipografia(JLabel fuenteLbl, JButton fuenteBtn, JRadioButton fuenteRbtn, JTextField fuenteTxt,
	    JList<String> fuenteList) {
...
//			Negro: 60, 60, 72
	/*
	 * lblIcono.setIcon(new
	 * ImageIcon(PanBienvenida.class.getResource("/img/image2.png")));
	 * lblIcono.setOpaque(true); lblIcono.setBorder(null);
	 * lblIcono.setForeground(new Color(0, 0, 0)); lblIcono.setBackground(new
	 * Color(255, 255, 255)); lblIcono.setHorizontalAlignment(SwingConstants.LEFT);
