...
public class FuncionesServicios {
    ...
    /**
     * Este es el constructor de funcionesServicios, al cual le pasamos el
    ...
    /**
     * Este método activa el panel de los servicios adicionales si el usuario ha
     * seleccionado algun alojamiento
     */
	...
	if (vista.buscarAlojamiento.panelHotel.isVisible() == true) {
		...
		JOptionPane.showMessageDialog(vista,
			"Por favor, seleccione un alojamiento para poder ver sus servicios disponibles. Gracias.", null,
			0);
	} else {
    ...
    /**
     * Este metodo hace visible los todos los componentes del panel servicios
     * adicionales. Además llama al metodo de comprobarServicios.
     */
    ...
    /**
     * Este metodo mira que servicios estan seleccionados y llama al metodo que
     * calcula el precio de los servicios.
     */
	...
	if (modelo.servicios != null) {
		...
		return true;
	    else if (modelo.apartamento != null
		    && modelo.apartamento.getCodAlojamiento() == modelo.servicios.getCodAlojamiento())
		return true;
	    else
		return false;
	} else
