...
public class ControladorPanBases implements ActionListener {
	...
	case "Declinar":
	    if (JOptionPane.showConfirmDialog(vista,
		    "¿Estas segudo de querer declinar las politicas? Si lo haces se reseteara la aplicacion",
		    "Declinar politicas", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
