...
public class Apartamento extends Casa {
     ...
     */
    public Apartamento(int codAlojamiento, String nombre, String direccion, String telefono, int numHabitaciones,
	    String ubicacion, float precioAlojamiento, int popularidad, int numBanos, float metrosCuadrados, int piso,
	...
	super(codAlojamiento, nombre, direccion, telefono, numHabitaciones, ubicacion, precioAlojamiento, popularidad,
		numBanos, metrosCuadrados, arrayNombreHabitaciones, arrayNumHabitaciones);
	this.piso = piso;
    }
