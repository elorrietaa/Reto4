...
public class ReservaTest {
  /*
    ...
    private Alojamiento alojamiento=new Alojamiento(1, "Hotel Melia","Calle mayor", "666 666 666", 5, "Bilbao", (float) 54.2, 10, arrayNombreHabitaciones, arrayNumHabitaciones);
