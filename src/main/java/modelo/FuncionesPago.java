...
public class FuncionesPago {
	...
	public String sobra(float total, float dinero){
		...
		{ 
			sobra = dinero-total;
	        if(sobra >= 200) //si la cantidad es mayor que este num, se divide entre el para saber la cantidad de billetes de este tipo,y calcula el resto para saber el dinero que le queda por analizar.
	        {
	             cont = (int) sobra/200;
	             sobra = sobra%200;
